...
public class MongoDb implements CursorInter{
	 ...
	 * @return
	 */
	public boolean existCollection(String collections)
	{
		return db.collectionExists(collections);
	}
	/**
	 * 清空表
	 * @param collections
	...
	public DBCursor find(String collection,String ref,String obj) {
		DBCollection coll = db.getCollection(collection);
		return coll.find((DBObject) JSON.parse(ref),(DBObject) JSON.parse(obj));
	}
	...
	{
		return this.ip+":"+port+"/database="+database+"/table="+collection;
	}

	@Override
	public void insertString(String insertString) {
		// TODO Auto-generated method stub
		this.insert(collection, insertString);
	}
	/**
	 * 更新 doc 为doc2
	 * 
